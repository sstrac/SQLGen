...
export class InsertFormComponent implements OnInit {
  ...
  generateInsertStatement() {
    if(this.formGroup['PROFILE_name'] != undefined && this.formGroup['PROFILE_type'] != undefined)
      this.statements += "/* ========== " + this.formGroup['PROFILE_name'].toUpperCase() + " - " + this.formGroup['PROFILE_type'].toUpperCase() + " ========== */" + "\n\n"
    this.tables.forEach(table => {
